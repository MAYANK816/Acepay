...
public class MainActivity extends AppCompatActivity
{
    ...
    void payUsingUpi(String amount, String upiId, String name, String note)
    {
        ...
        {
            Toast.makeText(MainActivity.this,"No UPI app found, please install one to continue",
    ...
    private void upiPaymentDataOperation(ArrayList<String> data)
    {
        if (isConnectionAvailable(MainActivity.this))
        {
            ...
            {
                Toast.makeText(MainActivity.this, "Transaction failed.Please try again",
                        Toast.LENGTH_SHORT).show();
            }
        }
        else
        {
            Toast.makeText(MainActivity.this, "Internet connection is not available.Please check and try again",
                    Toast.LENGTH_SHORT).show();
        }
    }
