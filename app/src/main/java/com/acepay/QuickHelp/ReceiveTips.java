...
//
//public class ReceiveTips extends AppCompatActivity {
...
//        setContentView(R.layout.activity_receive_tips);
//        // iv_withdraw=(ImageView)findViewById(R.id.iv_withdraw);
//        tv_info=(TextView)findViewById(R.id.tv_info);
//        tv_skip=(TextView)findViewById(R.id.tv_skip);
//        tv_next=(TextView)findViewById(R.id.tv_next);
//        lnRece=(LinearLayout)findViewById(R.id.lnRece) ;
//        tv_info.setText("Here, you can Receive the wallet money from the other wallet Account.");
...
//                Intent intent=new Intent(ReceiveTips.this, Dashboard.class);
...
//            @Override
//            public void onClick(View view) {
//                Intent intent=new Intent(ReceiveTips.this,InrTransactionTips.class);
//                startActivity(intent);
//
//            }
//        });
