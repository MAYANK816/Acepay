...
//
//public class InrTransactionTips extends AppCompatActivity {
...
//                Intent intent=new Intent(InrTransactionTips.this, Dashboard.class);
