...
public class GradientFontSpinner extends Spinner {

    public GradientFontSpinner(Context context) {
        super(context);
        init();
    }

    public GradientFontSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public GradientFontSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
